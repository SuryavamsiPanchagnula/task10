...
class herbal_Tea extends Tea3{
	...
	public void prepareTea() {
		...
		if(c_yes) {
			...
			System.out.println("2.Herbal Masala");
			System.out.println("3.Ginger");
			int ingredient = sc.nextInt();
			...
			case 1:
				System.out.println("Honey added");
				break;
			case 2:
				System.out.println("Herbal Masala added");
				break;
			case 3:
				System.out.println("Ginger added");
				break;
...
public class array_polymorphism {
	...
	public static void main(String args[]) {
		...
		System.out.println("Choose type of tea to drink");
		System.out.println("1.BlackTea");
		System.out.println("2.GreenTea");
		System.out.println("3.HerbalTea");
